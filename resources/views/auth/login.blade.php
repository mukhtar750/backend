            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5" x-data="{ show: false }">
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        {{-- <a href="{{ route('password.request') }}" class="text-sm text-gray-500 forgot-password">Forgot Password?</a> --}}
                    </div>
                    <div class="relative">
                ...
                <div class="text-center text-sm text-gray-600 mt-4">
                    ...
                    <a href="{{ route('register.role') }}" class="font-medium register-link">Register</a>
                </div>
            </form>
        </div>
