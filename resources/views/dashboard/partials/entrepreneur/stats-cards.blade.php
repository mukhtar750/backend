<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
    <a href="{{ route('entrepreneur.progress') }}" class="bg-white p-6 rounded-xl shadow flex items-center border border-gray-100 justify-between hover:shadow-lg transition">
        <div>
    ...
    <a href="{{ route('entrepreneur.calendar') }}" class="bg-white p-6 rounded-xl shadow flex items-center border border-gray-100 justify-between hover:shadow-lg transition">
        <div>
    ...
    <a href="{{ route('entrepreneur.mentorship') }}" class="bg-white p-6 rounded-xl shadow flex items-center border border-gray-100 justify-between hover:shadow-lg transition">
        <div>
    ...
    <a href="{{ route('entrepreneur.pitch') }}" class="bg-white p-6 rounded-xl shadow flex items-center border border-gray-100 justify-between hover:shadow-lg transition">
        <div>
