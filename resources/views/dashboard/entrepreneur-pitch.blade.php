            ...
            @forelse($pitchResources as $resource)
                <div class="bg-white rounded-xl shadow p-5 flex flex-col">
                    ...
                    @if($resource->file_path)
                        <a href="{{ route('entrepreneur.resource.download', $resource->id) }}" class="mt-auto bg-[#b81d8f] text-white px-4 py-2 rounded-lg font-medium text-center hover:bg-[#a01a7d] transition">
