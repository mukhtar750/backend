<div class="bg-white rounded-2xl shadow p-6 mb-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <span class="text-sm font-semibold text-[#b81d8f]">Overall: <?php echo e($overallProgress ?? '68%'); ?> Complete</span>
    </div>
    <div class="space-y-6">
        ...
        <div class="border rounded-xl p-4 flex flex-col gap-2">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('entrepreneur.module', ['module' => 'financial-planning'])); ?>" class="ml-2 bg-[#b81d8f] hover:bg-[#a259e6] text-white text-xs font-semibold px-3 py-1 rounded-lg transition">Go to Module</a>
                </div>
            </div>
            <div>
                <div class="text-xs text-gray-400 mb-1">Progress</div>
        ...
        <div class="border rounded-xl p-4 flex flex-col gap-2">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <span class="bg-blue-50 text-blue-700 text-xs px-2 py-1 rounded-full flex items-center gap-1">in progress</span>
                    <a href="<?php echo e(route('entrepreneur.module', ['module' => 'pitch-deck-creation'])); ?>" class="ml-2 bg-[#b81d8f] hover:bg-[#a259e6] text-white text-xs font-semibold px-3 py-1 rounded-lg transition">Go to Module</a>
                </div>
            </div>
            <div>
                <div class="text-xs text-gray-400 mb-1">Progress</div>
        ...
        <div class="border rounded-xl p-4 flex flex-col gap-2">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('entrepreneur.module', ['module' => 'legal-framework'])); ?>" class="ml-2 bg-[#b81d8f] hover:bg-[#a259e6] text-white text-xs font-semibold px-3 py-1 rounded-lg transition">Go to Module</a>
                </div>
            </div>
            <div>
                <div class="text-xs text-gray-400 mb-1">Progress</div>
...
</div> <?php /**PATH C:\Users\ABU-UMAR\Documents\GitHub\backend\resources\views/dashboard/partials/entrepreneur/learning-progress.blade.php ENDPATH**/ ?>