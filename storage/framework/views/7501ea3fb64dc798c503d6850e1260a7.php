        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="character-card bg-white rounded-xl shadow-md overflow-hidden glow-hover">
                ...
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('register.bdsp')); ?>" class="mt-6 w-full bg-purple-100 hover:bg-purple-200 text-purple-800 font-medium py-2 px-4 rounded-lg transition duration-300 block text-center">Explore Path</a>
                </div>
            </div>
            <!-- Entrepreneur Card -->
            <div class="character-card bg-white rounded-xl shadow-md overflow-hidden glow-hover">
                ...
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('register.entrepreneur')); ?>" class="mt-6 w-full bg-pink-100 hover:bg-pink-200 text-pink-800 font-medium py-2 px-4 rounded-lg transition duration-300 block text-center">Explore Path</a>
                </div>
            </div>
            <!-- Investor Card -->
            <div class="character-card bg-white rounded-xl shadow-md overflow-hidden glow-hover">
                ...
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('register.investor')); ?>" class="mt-6 w-full bg-blue-100 hover:bg-blue-200 text-blue-800 font-medium py-2 px-4 rounded-lg transition duration-300 block text-center">Explore Path</a>
                </div>
            </div>
            <!-- Mentor Card -->
            <div class="character-card bg-white rounded-xl shadow-md overflow-hidden glow-hover">
                ...
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('register.mentor')); ?>" class="mt-6 w-full bg-green-100 hover:bg-green-200 text-green-800 font-medium py-2 px-4 rounded-lg transition duration-300 block text-center">Explore Path</a>
                </div>
            </div>
            <!-- Mentee Card -->
            <div class="character-card bg-white rounded-xl shadow-md overflow-hidden glow-hover">
                ...
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('register.mentee')); ?>" class="mt-6 w-full bg-yellow-100 hover:bg-yellow-200 text-yellow-800 font-medium py-2 px-4 rounded-lg transition duration-300 block text-center">Explore Path</a>
                </div>
            </div>
        </div>
    </main>
    ...
    <footer class="bg-white py-8 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
        <div class="container mx-auto text-center">
            <p class="text-gray-600 mb-4">Already part of us?
                <a href="<?php echo e(route('login')); ?>" class="inline-block ml-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300">Login Now</a>
            </p>
...
</html><?php /**PATH C:\Users\ABU-UMAR\Documents\GitHub\backend\resources\views/auth/register-role.blade.php ENDPATH**/ ?>