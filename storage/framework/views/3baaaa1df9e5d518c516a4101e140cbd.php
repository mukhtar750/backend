<?php $__env->startSection('title', 'Assignments & Tasks'); ?>
...
<div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($totalTasks ?? 0); ?></p>
                </div>
        ...
        <div class="bg-green-50 border-l-4 border-green-500 rounded-lg p-4">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($completedTasks ?? 0); ?></p>
                </div>
        ...
        <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-4">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($inProgressTasks ?? 0); ?></p>
                </div>
        ...
        <div class="bg-red-50 border-l-4 border-red-500 rounded-lg p-4">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($overdueTasks ?? 0); ?></p>
                </div>
    ...
    <div class="space-y-4">
        <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-xl shadow p-6 mb-6">
                ...
                <?php if(!$submission): ?>
                    <form action="<?php echo e(route('tasks.submissions.store', $task)); ?>" method="POST" enctype="multipart/form-data" class="mt-4 bg-gray-50 p-4 rounded">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                ...
                <?php else: ?>
                    <div class="mt-4">
                        <a href="<?php echo e(route('submissions.show', $submission)); ?>" class="text-green-700 font-semibold hover:underline">View Submission</a>
    ...
    <div class="mt-6 flex justify-between items-center">
        <p class="text-sm text-gray-600">Showing <?php echo e($tasks->count()); ?> of <?php echo e($totalTasks ?? 0); ?> tasks</p>
...
<?php echo $__env->make('layouts.entrepreneur', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ABU-UMAR\Documents\GitHub\backend\resources\views/dashboard/entrepreneur-tasks.blade.php ENDPATH**/ ?>